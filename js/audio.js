class AudioManager {
  ...
  playPongWall() {
    this.playBeep(450, 250, 0.06, 'square', 0.12);
  }
  ...
  playPongMiss() {
    this.playBeep(220, 80, 0.35, 'sawtooth', 0.12);
  }

  // Tetris Sound FX
  playTetrisMove() {
    this.playBeep(130, 80, 0.03, 'triangle', 0.15);
  }

  playTetrisRotate() {
    this.playBeep(300, 450, 0.06, 'triangle', 0.15);
  }

  playTetrisLock() {
    this.playBeep(90, 50, 0.1, 'triangle', 0.2);
  }
